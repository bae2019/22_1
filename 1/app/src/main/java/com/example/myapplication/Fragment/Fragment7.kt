...
class Fragment7 : Fragment() {
    ...
    override fun onStart() {
        ...
        val lablist = arrayListOf(
            InLab(Pname = "최두현", Lname = "지능정보시스템 연구실", Laddress = "IT3-603A", Laddress2 = "IT3-603"),
            InLab(Pname = "최무한\n(학부장)", Lname = "포토닉스 메타소자 연구실", Laddress = "IT1-917", Laddress2 = "IT1-906"),
            InLab(Pname = "최병조", Lname = "스위치모드 전력변환 연구실", Laddress = "IT3-315", Laddress2 = "IT3-314"),
            InLab(Pname = "최봉열", Lname = "신호추정 연구실", Laddress = "IT2-228", Laddress2 = "IT2-228A,\n228B"),
            InLab(Pname = "최상조", Lname = "전자기 소자 및 시스템 연구실", Laddress = "E7-411", Laddress2 = "E7-415"),
            InLab(Pname = "최정식", Lname = "지능형 통신 및 센싱 연구실", Laddress = "E7-305", Laddress2 = " "),
            InLab(Pname = "최준림", Lname = "지능형 반도체 연구실", Laddress = "IT3-415", Laddress2 = "IT3-414"),
